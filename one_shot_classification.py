...
iterations_num = 200
batch_num = 32
df_train_results, df_validation_results, test_loss, test_acc, conv_runtime = siamese_net.train_model_net(X_train, y_train, X_val, y_val, X_test, y_test, iterations_num, batch_num, list_same_train, list_diff_train, siamese_model)# insert X and YYYYYYYYYYYY


# df_train_results, df_validation_results, test_loss, test_acc = siamese_model.evaluate([X_test[0], X_test[1]], y_test)
